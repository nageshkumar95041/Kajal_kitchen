...
async function seedMenu() {
    ...
    if (count < 10) {
        ...
        await MenuItem.insertMany([
            ...
            { name: 'Roti / Chapati', price: 15, description: 'Whole wheat flatbread.', category: "🍲 Main Course" },
            { name: 'Butter Roti', price: 20, description: 'Whole wheat flatbread brushed with butter.', category: "🍲 Main Course" },
            { name: 'Tandoori Roti', price: 25, description: 'Crispy whole wheat bread baked in a clay oven.', category: "🍲 Main Course" },
            { name: 'Plain Naan', price: 35, description: 'Soft and fluffy leavened bread.', category: "🍲 Main Course" },
            { name: 'Butter Naan', price: 45, description: 'Soft naan brushed with generous butter.', category: "🍲 Main Course" },
            { name: 'Garlic Naan', price: 55, description: 'Naan topped with minced garlic and cilantro.', category: "🍲 Main Course" },
            { name: 'Lachha Paratha', price: 40, description: 'Multi-layered, flaky whole wheat bread.', category: "🍲 Main Course" },
            { name: 'Aloo Paratha', price: 50, description: 'Whole wheat flatbread stuffed with spiced potatoes.', category: "🍲 Main Course" },
            { name: 'Paneer Paratha', price: 70, description: 'Whole wheat flatbread stuffed with spiced grated paneer.', category: "🍲 Main Course" },
            { name: 'Plain Rice', price: 80, description: 'Steamed basmati rice.', category: "🍲 Main Course" },
            { name: 'Jeera Rice', price: 100, description: 'Basmati rice tempered with cumin seeds.', category: "🍲 Main Course" },
            { name: 'Veg Pulao', price: 140, description: 'Fragrant rice cooked with mixed vegetables.', category: "🍲 Main Course" },
            { name: 'Veg Biryani', price: 180, description: 'Aromatic layered rice and vegetable dish cooked with spices.', category: "🍲 Main Course" },
            { name: 'French Fries', price: 80, description: 'Crispy, golden potato fries.', category: "🍲 Main Course" },
            { name: 'Green Salad', price: 60, description: 'Fresh cucumber, tomatoes, carrots, and onions.', category: "🍲 Main Course" },
            { name: 'Onion Salad', price: 40, description: 'Sliced onions with green chilies and lemon.', category: "🍲 Main Course" },
            { name: 'Boondi Raita', price: 70, description: 'Yogurt mixed with crispy gram flour pearls and spices.', category: "🍲 Main Course" },
